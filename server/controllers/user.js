...
//import User from 'your-user-model-path'; // Update with the correct path
...
export const getFollowersCount = async (req, res, next) => {
  try {
    ...
    // Log the error or handle it more specifically based on your needs
    console.error("Error in getFollowersCount:", err);
